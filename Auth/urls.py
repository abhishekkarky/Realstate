...
urlpatterns = [
    ...
    path('admin-edit-testimonial/<int:id>', views.edit_testimonial, name='edit-testimonial'),
    ...
    path('admin-delete-testimonial<int:id>', views.admin_delete_test, name='delete-testimonial'),
